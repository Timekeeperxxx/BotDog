...
start "MediaMTX" cmd /k "cd /d %ROOT_DIR% && "%MEDIAMTX_EXE%" "%ROOT_DIR%mediamtx.yml""

start "FFmpeg" cmd /k "cd /d %ROOT_DIR% && set \"FFMPEG_PATH=%FFMPEG_PATH%\" && set \"CAMERA_RTSP_URL=%CAMERA_RTSP_URL%\" && set \"MEDIA_MTX_RTSP_URL=%MEDIA_MTX_RTSP_URL%\" && .\ffmpeg-supervisor.cmd"
